...
{
    public class RunnableHostedService : IHostedService
    {
        private readonly IApplicationLifetime _applicationLifetime;
        private readonly ILogger _logger;
        private readonly IScheduler _quartzScheduler;

        public RunnableHostedService(IApplicationLifetime applicationLifetime, ILogger logger, IScheduler quartzScheduler)
        {
